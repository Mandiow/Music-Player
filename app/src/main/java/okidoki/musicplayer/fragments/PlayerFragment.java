...
public class PlayerFragment extends android.support.v4.app.Fragment implements MediaPlayer.OnCompletionListener,SeekBar.OnSeekBarChangeListener, Runnable {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageButton rewindImageButton = (ImageButton) view.findViewById(R.id.rewindButton);
        rewindImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(musicPlayer.mediaPlayer.isPlaying()) {
                    if (musicPlayer.currentSong == 0)
                        musicPlayer.playSong(musicList.musicListSize() - 1,false, true);
                    else
        ...
        ImageButton forwardImageButton = (ImageButton) view.findViewById(R.id.forwardButton);
    ...
    public static void updateSongInfo(int id) {
        ...
        if (id != lastID) {
            ...
            Log.e("MusicPlayer:",musicPlayer.toString());
            Log.e("MusicPlayer.musicqueue:",musicPlayer.musicQueue.toString());
    ...
    public void run() {
        if (musicPlayer == null){
            ...
            musicPlayer.musicQueue = MainActivity.globalMusicList;
        }
    ...
    public int MusicListSize(){
        return this.musicList.musicListSize();
    }
}